...
namespace Kaisa.Digivice {
    public class SpriteDatabase : MonoBehaviour {
        ...
        public Sprite[] pressAButton = new Sprite[3];
        public Sprite hourglass;
        public Sprite error;
        public Sprite error_finder;
        ...
        [Header("Menus")]
        public Sprite[] mainMenu = new Sprite[4];
        public Sprite[] mainMenu2= new Sprite[2];
        [Header("Map")]
        ...
        public Sprite[] database_sections = new Sprite[7];
        public Sprite database_spirit_fusion;
        public Sprite[] elements = new Sprite[10];
        public Sprite[] Spirits = new Sprite[11];
        ...
        public Sprite[] MenusSpiritPower = new Sprite[6];
