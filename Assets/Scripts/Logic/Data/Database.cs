...
namespace Kaisa.Digivice {
    public static class Database {
        ...
        public static void LoadDatabases() {
            ...
            Characters= LoadCharactersFromFile();
        ...
        private static Digimon[] LoadDigimonFromFile() {
         ...
         private static Characters[] LoadCharactersFromFile() {
            string charactersDBJson = ((TextAsset)Resources.Load("characters")).text;
            JArray dbArray = JArray.Parse(charactersDBJson);

            List<Characters> tempList = new List<Characters>();

            for (int i = 0; i < dbArray.Count; i++) {
                Characters d = dbArray[i].ToObject<Characters>();
        ...
        public static List<Digimon> GetSpiritsStart() {
            List<Digimon> spirits=new List<Digimon>();
            foreach (Digimon d in Digimons) {
                if ((int)d.stage == 10 && d.element!=Element.Dark) {
                    spirits.Add(d);
        ...
        public static List<string> GetSpiritsStartName() {
            List<string> spirits=new List<string>();
            foreach (Digimon d in Digimons) {
                if ((int)d.stage == 10 && d.element!=Element.Dark) {
                    spirits.Add(d.name.ToLower());
        ...
        public static float GetEraseChance(string digimon) {
            ...
            switch (rarity) {
                ...
                case Rarity.Boss:
                    ...
                    if (d.stage == Stage.Spirit || (int)d.stage==10 ) {
